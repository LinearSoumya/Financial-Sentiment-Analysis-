...
from sklearn.linear_model import LogisticRegression  # Change the classifier
...
# Lazy loading of the model and heavy computations
if 'pipeline' not in st.session_state:
    # Build the pipeline with CountVectorizer and Logistic Regression (simpler model)
...
# Determine color and emoji based on sentiment
    ...
    emoji = '😊' if user_prediction_label == 'POSITIVE' else ('😐' if user_prediction_label == 'NEUTRAL' else '😔')
